    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/mesonbuild/meson/"
                           ...
                           ".tar.gz"))
       (sha256
        (base32 "15jlkp0fxwir26k0rmf3n25l3qi2mlgrqj352gqiqm033kr6b6wr"))))))
...
(define-public aquamarine
  (package
    ...
    (description
     "Aquamarine is a very light linux rendering backend library. It provides basic
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0ld0sj7ahf9jf8cqzbqkhj3m2w60027ixic24ih26nwy90b5qjwx"))))
      ...
      #:phases #~(modify-phases %standard-phases
                   ...
                   (add-after 'install 'wrap
                     (lambda* (#:key inputs #:allow-other-keys)
                       (let ((grimblast (string-append #$output
                                                       "/bin/grimblast")))
...
(define-public hyprcursor
  (package
    ...
    (arguments
     (list
      #:tests? #f)) ;TODO: No themes packaged.
...
(define-public hyprland
  (package
     ...
     (origin
       ...
       (snippet '(begin
                   ...
                   (substitute* "meson.build"
                     ((".*hyprpm/src.*")
                      ""))
                   (copy-file "scripts/generateVersion.sh.bak"
                              "scripts/generateVersion.sh")
                   (for-each delete-file-recursively
                             '("hyprpm" "subprojects"))))
       (sha256
        (base32 "0qzwdlj0bwj267285l3gjklhafn3bln90z985yws4j5cbp7bj0d9"))))
                   ...
                   (add-after 'unpack 'fix-path
                     (lambda* (#:key inputs #:allow-other-keys)
                       (substitute* (find-files "src" "\\.cpp$")
                         ...
                         (("/usr")
                          #$output)
                         (("(execAndGet\\(\")\\<(cat|fc-list|lspci)\\>" _ pre
                           cmd)
                          (string-append pre
    ...
    (native-inputs (list gcc-14 hyprwayland-scanner jq pkg-config
                         wayland-1.23.1))
...
(define cairo-for-hyprland
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append "https://cairographics.org/releases/cairo-" version
                           ".tar.xz"))
       (sha256
    ...
    (arguments
     (list
      #:tests? #f
      #:glib-or-gtk? #t
      #:configure-flags #~(list "-Dspectre=disabled")))
    (outputs '("out"))))
    ...
    (source
     (origin
       ...
       (uri (string-append "https://dri.freedesktop.org/libdrm/libdrm-"
                           version ".tar.xz"))
       (sha256
        (base32 "0yijzgg6rdsa68bz03sw0lcfa2nclv9m3as1cja50wkcyxim7x9v"))))))
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             ".tar.xz"))
       (sha256
        (base32 "14kyxywpfkgpjpkrybs28q1s2prnz30k1b4zap5a3ybrbvh4vzbi"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "010bqvic471prhja1j5xqni9dhqc36ikqpxi8ih0fs13wph70p4s"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1s6vhzln0rvac2r3v8nq08hsjhyz3y46fsy18i23ppjm30apkiav"))))
    (arguments
    ...
    (source
     (origin
       ...
       (uri (string-append "https://gitlab.freedesktop.org/"
                           ...
                           ".tar.xz"))
       (sha256
        (base32 "1vg5h6d94hglh7724q6wx9dpg4y0afvxksankp1hwbcy76lb4kw6"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1irj7pqz6jk4l911p33yragmfsqixgwfg1k9djkz2sdca9ddf809"))))
