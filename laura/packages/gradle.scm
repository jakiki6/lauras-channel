...
(define-public java-apache-ivy-2.0.0
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append "mirror://apache//ant/ivy/" version "/apache-ivy-"
                           version "-src.tar.gz"))
       (sha256
        (base32 "07ddff7gpwjqq1fv21867jp4w3444wzzhg2h90g63mgh4vw51dcr"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "05hgi2z01fqz374y719gl1dxzqvzci5af071zm7vxrjg9vczipm1"))))))
  ...
  (package
    ...
    (arguments
     `(#:phases (modify-phases %standard-phases
                  (add-before 'build 'patch-ivy
                    (lambda* (#:key inputs #:allow-other-keys)
                      (use-modules (ice-9 textual-ports))
                      (mkdir-p "ivy")
                      (copy-file (string-append (assoc-ref inputs
                                                           "java-apache-ivy")
                                                "/share/java/ivy.jar")
                      ...
                      (setenv "_JAVA_OPTIONS"
                              (string-append "-Duser.home="
                                             (getcwd)))))
                  (add-before 'build 'inject-dependencies
                    (lambda* (#:key inputs #:allow-other-keys)
                      (mkdir-p ".ivy2/local/commons-cli/commons-cli/1.0/jars")
                      (copy-file (string-append (assoc-ref inputs
                                                           "java-commons-cli")
                                  "/lib/m2/commons-cli/commons-cli/1.4/commons-cli-1.4.jar")
                       ".ivy2/local/commons-cli/commons-cli/1.0/jars/commons-cli.jar")
                      (mkdir-p
                       ".ivy2/local/org.codehaus.groovy/groovy-all/1.5.5-032808")
                      (copy-recursively (string-append (assoc-ref inputs
                                                                  "groovy")
                                                       "/lib")
                       ".ivy2/local/org.codehaus.groovy/groovy-all/1.5.5-032808/jars")
                      (copy-file
                       ".ivy2/local/org.codehaus.groovy/groovy-all/1.5.5-032808/jars/groovy.jar"
                       ".ivy2/local/org.codehaus.groovy/groovy-all/1.5.5-032808/jars/groovy-all.jar"))))))
